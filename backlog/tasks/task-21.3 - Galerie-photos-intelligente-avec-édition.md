...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [x] #1 Accès depuis l'éditeur à une vue Galerie avec 3 modes d'affichage (grille, compacte, liste) affichant toutes les photos importées.
- [x] #2 Filtres combinables par texte, lieu, plage de dates et tags avec tri dynamique et compteur de résultats.
- [x] #3 Sélection multiple avec barre d'actions flottante (favoris, téléchargement, suppression) et état persistant.
- [x] #4 Badges IA (coup de cœur, alertes qualité) et panneau suggestions (au moins 4 layouts) générés automatiquement selon les photos sélectionnées.
- [x] #5 Modal d'édition photo avec filtres prédéfinis, sliders luminosité/contraste/saturation, rotation 90°, recadrage multi-ratios, undo/redo et prévisualisation en direct.
- [x] #6 Jeux de tests unitaires couvrant filtres, sélection et application des réglages d'édition.
<!-- AC:END -->
